...
- **FEC**: <https://api.open.fec.gov/developers/> (the signup form is at the top of the page)
...
```{python}
# Give each API's endpoint its own clearly named variable -- a generic name like `url` invites bugs when you move between APIs in one notebook
