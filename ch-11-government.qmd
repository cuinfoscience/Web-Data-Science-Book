...
::: {.callout-tip}
## Companion Notebook
Run this chapter's code as you read: download the [companion notebook](notebooks/ch-11-government.ipynb) (see @sec-appendix-notebooks for all of them).
:::
