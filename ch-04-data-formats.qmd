...
A JSON object naturally maps to a Python dictionary, which is accessed by key. Python dictionaries preserve insertion order, but JSON object member order should not be relied on:
