...
::: {.callout-tip}
## Learn More About the W3C

Curious what the [World Wide Web Consortium (W3C)](https://www.w3.org/) actually does? Their site covers the standards working groups (including the ones behind XML), the technical resources and specifications they publish, and how organizations can support or join the consortium's work.
:::
