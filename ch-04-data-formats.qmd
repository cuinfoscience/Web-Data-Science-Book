...
The Changelog, a software podcast, was on this list until a reader ran Step 1's check on it: its `robots.txt` disallows every path, its feed included. That check is worth running on every feed, this list's included.
