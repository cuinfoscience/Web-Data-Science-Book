...
```{python}
# Step 1: Choose a Wikipedia article with a table, confirm robots.txt
# allows it, and fetch the page with your HEADERS.
# Your code here
```
...
```{python}
# Step 3: Run pd.read_html on the cached HTML, count the tables, and
# pick out yours.
# Your code here
```
...
```{python}
# Step 6: Parse the cached HTML with BeautifulSoup, find your table by
# class, and extract the header row by hand.
# Your code here
```
