...
```{python}
# Step 2: Build a DataFrame of captures with real datetimes and numeric
# lengths. Print the date range and capture count.
# Your code here
```
...
```{python}
# Step 4: Fetch the earliest and latest captures with the id_ suffix,
# politely, and cache both to disk.
# Your code here
```
...
```{python}
# Step 5: Extract text from both captures, preprocess, and compute
# their similarity.
# Your code here
```
