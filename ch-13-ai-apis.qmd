...
```{python}
# Step 1: Load your API key from the environment, create the client, and
...
```{python}
# Step 2: Collect 15 short texts with an earlier chapter's method, build
# a DataFrame, and save it to CSV.
# Your code here
```
...
```{python}
# Step 3: Define your labels in a comment and hand-label all 15 items
# into a human_label column BEFORE running the model.
# Your code here
```
...
```{python}
# Step 4: Write the few-shot prompt and classify all 15 items into a
# model_label column.
# Your code here
```
...
```{python}
# Step 5: Compute the agreement rate, build the crosstab, and display
# every disagreement.
# Your code here
```
