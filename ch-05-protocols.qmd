...
```{python}
# Step 3: Make a request with your HEADERS and print the status code and
...
```{python}
# Step 4: Write diagnose_url(url) -- status, content-type, server, size,
# and the redirect chain if any. Include a docstring.
# Your code here
```
