...
- **Windows Running from elevated PowerShell:** open the Start menu, sesarch for Windows PowerShell, right click and select "Run as adminstrator", then from that elevated terminal, navigate to the appropriate folder and run jupyter as usual.
::: {.callout-warning}
