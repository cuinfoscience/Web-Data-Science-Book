...
**Step 2 — Resolve a name.** Use `dns.resolver` to look up the A records for `en.wikipedia.org` and two other domains you choose. Print the IP addresses. Do any share an address?
 ...
 -- For students who are unable to run scapy on their computer, this question is optional. If sacpy is not working, check the debugging and install instructions and verify that you are following the procedures correctly. --
