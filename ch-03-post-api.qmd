...
::: {.callout-tip}
## Companion Notebook
This chapter's [companion notebook](https://github.com/cuinfoscience/Web-Data-Science-Book/blob/main/notebooks/ch-03-post-api.ipynb) contains the discussion and exercises for note-taking — this is a conceptual chapter with no code (see @sec-appendix-notebooks for all notebooks).
:::
