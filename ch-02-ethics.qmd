...
For a deeper introduction to HTTP requests, headers, and status codes — the machinery beneath every example in this chapter — see *Missing Manual* Chapter 24: HTTP and Web APIs. (https://cuinfoscience.github.io/INFO-Missing-Manual/chapters/http-apis.html) 
:::
